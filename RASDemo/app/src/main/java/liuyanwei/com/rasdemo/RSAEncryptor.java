...
/**
 * Created by xuanyan.lyw 刘彦玮（玄彦） on 2017/1/23.
 */
public class RSAEncryptor {

    public RSAEncryptor(String public_key,String private_key) throws Exception {
        loadPublicKey(public_key);
        loadPrivateKey(private_key);
    }

    //根据key的路径获取key string值
    static public String getKeyFromFile(String filePath) throws Exception {
    ...
    //根据inputStream得到string
    static public String getStringByByte(InputStream inputStream){
    ...
    public String decryptWithBase64(String base64String) throws Exception {
        return new String(Base64.decode(base64String.getBytes(),Base64.DEFAULT));
    }

    public String encryptWithBase64(String string) throws Exception {
        byte[] binaryData = encrypt(getPublicKey(), string.getBytes());
        String base64String = Base64.encodeToString(string.getBytes(),Base64.DEFAULT);
        return base64String;
    }
